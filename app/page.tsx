    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      ...
      {loading && (
        <div className="p-12 text-center text-slate-500 font-medium bg-white rounded-xl border border-slate-200">
          <span className="inline-block animate-spin mr-2">🔄</span> テスト一覧をリアルタイム読み込み中...
        </div>
      )}
      ...
      {!loading && runs.length === 0 && (
        <div className="p-12 text-center bg-white rounded-xl border border-slate-200 text-slate-500 space-y-3">
          <p className="text-base font-bold text-slate-700">テスト項目書がまだありません</p>
